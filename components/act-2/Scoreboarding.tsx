...
export default function Scoreboarding() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Scoreboarding Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">Scoreboarding resolves hazards by tracking functional unit status and operand readiness.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Track busy units and operand availability in a central scoreboard.</p>
        </div>
      </div>
