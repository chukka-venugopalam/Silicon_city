...
export default function Prefetching() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Prefetching Strategies Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">Hardware prefetch detects sequential streams and warms the cache ahead of demand.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Prefetch contiguous blocks only when access patterns are predictable.</p>
        </div>
      </div>
