...
export default function CacheCoherency() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Cache Coherency Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">Shared memory regions need a coherence protocol to avoid stale data across multiple caches.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Tag the cache line and track ownership states rather than invalidating blindly.</p>
        </div>
      </div>
