...
export default function PipelineStalls() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Pipeline Stalls Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">A stall disables the next instruction until the hazard clears.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Forwarding can avoid many stalls, but control hazards still require careful handling.</p>
        </div>
      </div>
