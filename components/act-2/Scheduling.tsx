...
export default function Scheduling() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Scheduling Policies Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">Round-robin cycles through processes with equal time slices.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Use a circular queue to rotate CPU time fairly among ready tasks.</p>
        </div>
      </div>
