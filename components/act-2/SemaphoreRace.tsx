...
export default function SemaphoreRace() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Semaphore Race Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">A semaphore uses P and V operations to acquire and release permits.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Use V to signal the next waiting process when a resource is freed.</p>
        </div>
      </div>
