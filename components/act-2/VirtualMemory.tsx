...
export default function VirtualMemory() {
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h3 className="text-xl font-semibold text-slate-900">Virtual Memory Tiles Diagnostics</h3>
        <p className="mt-2 text-sm text-slate-600">The TLB maps virtual page numbers to frames in physical memory.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="text-sm text-slate-600">Remember that page tables translate virtual addresses before physical access.</p>
        </div>
      </div>
